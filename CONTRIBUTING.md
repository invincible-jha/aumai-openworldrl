# Contributing to AumAI Openworldrl
...
### Setup
```bash
git clone https://github.com/aumai/aumai-openworldrl.git
...
### Good First Issues
New to the project? Start with issues labeled [`good first issue`](https://github.com/aumai/aumai-openworldrl/labels/good%20first%20issue).
...
- [GitHub Discussions](https://github.com/aumai/aumai-openworldrl/discussions)
